...
function renderProfile() {
  ...
  shell(`${header('Мой профиль', 'Данные доступны только вам и HR.')}
    ...
    <section class="settings-card"><div class="section-head"><h2>Настройки аккаунта</h2><span class="muted">личный кабинет</span></div><button class="setting-row" data-action="language" data-id="0"><span><b>Язык приложения</b><small>Русский</small></span><strong>›</strong></button><button class="setting-row" data-action="theme"><span><b>Тема приложения</b><small>Системная · светлая</small></span><strong>›</strong></button><button class="setting-row"><span><b>Номер телефона</b><small>+7 (707) ***-42-86</small></span><strong>›</strong></button><button class="setting-row"><span><b>Уведомления</b><small>Включены для заданий и новостей</small></span><strong>›</strong></button></section>
